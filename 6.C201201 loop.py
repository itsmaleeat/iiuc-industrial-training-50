...
temperatures = [22, 45, 25, 40, 18, 35, 42]
threshold = 35  # Warning threshold
...
# Dictionary of products with stock levels
products = {
    "laptop": {"stock": 4, "min_required": 10},
    "smartphone": {"stock": 15, "min_required": 5},
    "tablet": {"stock": 8, "min_required": 10}
}
...
for product, details in products.items():
    ...
    if stock < min_required:
        print(f"Alert: Restock {product}. Current stock: {stock}, Minimum required: {min_required}")
