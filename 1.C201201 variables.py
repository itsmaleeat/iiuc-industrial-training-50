...
num = 100           # int
temperature = 98.6  # float (changed example)
...
print(fixed_bad_name, user_age, max_speed, is_student)
...
# Write your code below:
dynamic_var = 3.14
print("Initially:", dynamic_var, "Type:", type(dynamic_var))

dynamic_var = "Now I am a string"
print("Reassigned:", dynamic_var, "Type:", type(dynamic_var))
