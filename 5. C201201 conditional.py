...
resident = input("Are you a resident (yes/no)? ").lower() == 'yes'

# Check eligibility
if age >= 60 and resident:
...
# Input temperature and weather
temperature = int(input("Enter the temperature (°C): "))
weather = input("Enter the weather condition (sunny/cloudy/rainy/snowy): ").lower()
...
elif weather == "rainy" or (temperature < 20 and weather == "cloudy"):
    print("Stay home and relax.")
else:
    print("It's a regular day. Enjoy as you like!")
