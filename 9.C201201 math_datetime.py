...
time_in_years = 5  # 5 years

final_amount = calculate_compound_interest(principal, rate, compounds_per_year, time_in_years)
print(f"The final amount after interest is: ${final_amount:.2f}")
