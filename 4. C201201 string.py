...
bio_data = "Name: Bushra Rahman, Age: 25, Country: Bangladesh"

# Splitting the string to extract information
bio_parts = bio_data.split(', ')
name = bio_parts[0].split(': ')[1]
age = int(bio_parts[1].split(': ')[1])
...
formatted_string = (
    f"Hello! My name is {person_info['name']}, "
    f"I am {person_info['age']} years old, "
    f"I live in {person_info['country']}, and I work as a {person_info['profession']}."
)
...
# Example use
test_string = "This is the first session of field work"
counts = char_count(test_string)
