...
print("After adding English:", student)

# Removing a subject
removed_subject = student['grades'].pop('History')
print("Removed Subject (History):", removed_subject)
print("After removing History:", student)

# Modifying an existing grade
student['grades']['Math'] = 89
...
average_grades = {name: sum(grades)/len(grades) for name, grades in students_grades.items()}
